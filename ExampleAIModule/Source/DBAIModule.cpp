...
Position DBAIModule::findGuardPoint()
{
...
void DBAIModule::onSendText(std::string text)
{
...
void DBAIModule::onReceiveText(BWAPI::Player player, std::string text)
{
...
//No need to change this.
void DBAIModule::onPlayerLeft(BWAPI::Player player)
{
...
//No need to change this.
void DBAIModule::onNukeDetect(BWAPI::Position target)
{
...
//No need to change this.
void DBAIModule::onUnitDiscover(BWAPI::Unit unit)
{
	//Broodwar->sendText("A %s [%x] has been discovered at (%d,%d)",unit->getType().getName().c_str(),unit,unit->getPosition().x,unit->getPosition().y);
}

//No need to change this.
void DBAIModule::onUnitEvade(BWAPI::Unit unit)
{
	//Broodwar->sendText("A %s [%x] was last accessible at (%d,%d)",unit->getType().getName().c_str(),unit,unit->getPosition().x,unit->getPosition().y);
}

//No need to change this.
void DBAIModule::onUnitShow(BWAPI::Unit unit)
{
	//Broodwar->sendText("A %s [%x] has been spotted at (%d,%d)",unit->getType().getName().c_str(),unit,unit->getPosition().x,unit->getPosition().y);
}

//No need to change this.
void DBAIModule::onUnitHide(BWAPI::Unit unit)
{
...
//has been finished.
void DBAIModule::onUnitCreate(BWAPI::Unit unit)
{
...
void DBAIModule::onUnitDestroy(BWAPI::Unit unit)
{
	if (unit->getPlayer() == Broodwar->self())
	{
...
//No need to change this.
void DBAIModule::onUnitMorph(BWAPI::Unit unit)
{
	//Broodwar->sendText("A %s [%x] has been morphed at (%d,%d)",unit->getType().getName().c_str(),unit,unit->getPosition().x,unit->getPosition().y);
}

//No need to change this.
void DBAIModule::onUnitRenegade(BWAPI::Unit unit)
{
	//Broodwar->sendText("A %s [%x] is now owned by %s",unit->getType().getName().c_str(),unit,unit->getPlayer()->getName().c_str());
}

//No need to change this.
void DBAIModule::onSaveGame(std::string gameName)
{
...
//No need to change this.
void DBAIModule::drawTerrainData()
{
...
void DBAIModule::onUnitComplete(BWAPI::Unit unit)
{
